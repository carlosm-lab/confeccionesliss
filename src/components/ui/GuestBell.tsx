...
export function GuestBell() {
  ...
  const unreadCount = isActive ? 1 : 0;

  // El modal se renderiza en document.body via portal
  // para escapar del stacking context del header (backdrop-blur-md)
  const modal = isOpen
    ? createPortal(
        <div
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              {unreadCount === 0 ? (
                ...
                <ul className="divide-y divide-slate-100">
                  <li>
                    <div className="relative w-full bg-blue-50/60 px-5 py-4">
                      <div className="flex items-start gap-3">
                        <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-blue-50 ring-1 ring-blue-200">
                          <span
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="mt-0.5 text-[11px] leading-relaxed text-slate-400">
                            Inicia sesión para sincronizar tus favoritos en
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label={
          unreadCount > 0
            ? `Tienes ${unreadCount} notificación sin leer`
      ...
      {/* Portal — renderizado en document.body para escapar
          del stacking context creado por backdrop-blur-md del header */}
      {modal}
    </>
  );
}
