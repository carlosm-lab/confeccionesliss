...
export const siteConfig = {
  ...
  description:
    "Scrubs médicos y uniformes a la medida en San Miguel, El Salvador. Para UNIVO, UNAB, UGB y más instituciones. Tela Sincatex anti-fluidos. Desde $35, pago al recibir.",
