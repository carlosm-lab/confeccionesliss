...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* ═══ HERO ═══ */}
      <section className="bg-surface-container-low relative flex min-h-[calc(100dvh-56px)] flex-col justify-center overflow-x-hidden px-5 py-6 sm:py-8 md:px-8 md:py-10 lg:min-h-[calc(100dvh-56px)] lg:py-12">
        <div className="mx-auto grid w-full max-w-screen-2xl grid-cols-1 items-center gap-x-8 gap-y-8 md:grid-cols-2 lg:grid-cols-12 lg:gap-x-12">
          {/* COLUMNA IZQUIERDA: TÍTULO, DESCRIPCIÓN, BADGES Y ACCIONES */}
          <div className="z-10 order-1 flex w-full flex-col items-start justify-center md:col-span-1 lg:col-span-7">
            <h1 className="animate-fade-in-up text-primary mb-3 w-full text-center font-serif text-2xl leading-[1.15] tracking-tight sm:text-3xl md:mb-4 md:text-left md:text-4xl lg:mb-4 lg:text-4xl xl:text-5xl xl:leading-[1.1]">
              <span className="text-center md:text-left">
                Scrubs &amp; Uniformes Para el Sector Salud y Universidades{" "}
              </span>
              <span className="text-secondary font-serif md:mt-1 md:inline md:gap-0">
                <span className="shrink-0">en El Salvador</span>
              </span>
            </h1>

            <p
              className="animate-fade-in-up text-on-surface-variant font-body mb-5 w-full text-center text-sm leading-relaxed sm:text-base md:text-left md:text-base lg:mb-5 lg:text-lg"
            ...
            <div className="mb-6 grid w-full grid-cols-2 gap-x-2.5 gap-y-2 sm:gap-x-3 sm:gap-y-2.5 md:grid-cols-1 lg:grid-cols-2">
            ...
            <div className="flex w-full flex-col gap-3 sm:flex-row sm:gap-4">
              <Link
                href="/catalogo"
                prefetch={false}
                className="animate-fade-in-up btn-gradient font-body ambient-shadow flex h-11 w-full items-center justify-center rounded-md px-10 text-center text-base font-semibold whitespace-nowrap text-white transition hover:opacity-90 active:scale-[0.97] sm:flex-1"
              ...
              <a
                ...
                className="animate-fade-in-up border-outline text-primary hover:bg-surface-variant/50 flex h-11 w-full items-center justify-center rounded-md border bg-transparent px-10 text-center font-serif text-base font-medium whitespace-nowrap transition active:scale-[0.97] sm:flex-1"
          ...
          {/* COLUMNA DERECHA: IMAGEN HERO ÚNICA - OPTIMIZADA ESTÁTICA WEBP */}
          <div className="order-2 flex w-full max-w-sm self-center justify-self-center md:col-span-1 md:max-w-none lg:col-span-5 lg:items-center">
            <div className="border-primary/35 relative z-10 flex w-full flex-col items-center justify-center rounded-2xl border bg-white p-3.5 shadow-[0_0_25px_6px_rgba(20,48,103,0.15),0_0_10px_2px_rgba(20,48,103,0.1)] sm:p-4">
