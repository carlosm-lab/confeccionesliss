...
const PAGE_DESCRIPTION =
  "Historial de cambios, mejoras y nuevas funcionalidades del sitio web de Confecciones Liss. Cada versión documentada con transparencia: features, fixes, diseño y rendimiento.";
