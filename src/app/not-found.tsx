...
export default function NotFound() {
  return (
    <div className="bg-background text-on-background relative flex min-h-screen flex-col overflow-x-hidden">
      ...
      <main
        id="main-content"
        className="relative z-10 mx-auto flex w-full flex-grow flex-col items-center justify-center"
      >
          ...
          <div className="flex w-full flex-col items-center gap-8 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
            ...
            <div className="z-10 flex w-full flex-col items-center text-center lg:flex-1 lg:items-start lg:text-left">
              ...
              <p className="text-on-surface-variant max-w-xl text-base leading-relaxed md:text-lg">
                ...
                ha sido eliminada o nunca existió. Si crees que esto es un
                error, puedes utilizar la navegación superior para regresar a la
                página principal y explorar nuestras categorías de scrubs y
